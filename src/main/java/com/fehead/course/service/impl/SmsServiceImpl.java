...
import com.fehead.course.utils.CreateCodeUtil;
import com.fehead.course.utils.SmsUtil;
...
//                redisService.set("sms_key_" + telphone, key, new Long(300));
            ...
            case 1:
                ...
                break;
            case 2:
                redisService.set(securityProperties.getSmsProperties().getResetPreKeyInRedis() + smsCode.getTelphone(), smsCode, new Long(30*60));
                break;
            default:
                break;
        }
